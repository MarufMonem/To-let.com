...
$query = "SELECT * FROM user_ad WHERE type='sale'";
...
<html>
<head>
	<title>Sale Advertisement | To-Let.Com</title>
   ...
   <div class="collapse navbar-collapse" id="navbarNav">
     <ul class="navbar-nav">
       <li class="nav-item ">
         ...
         <li class="nav-item">
           <a class="nav-link active" href="browseSale.php"><i class="far fa-compass"></i> Browse Sale</a>
         </li>
         <li class="nav-item">
...
<div class="container">
  <h1>See all the advertisements in our disposal</h1>
  <hr>
